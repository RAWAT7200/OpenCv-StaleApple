...
import os
import numpy as np
subjects={1:"sub1",2:"sub2"}

def detect_face(img):
    gray=cv2.cvtColor(img,cv2.COLOR_BGR2GRAY)
    face_cascade=cv2.CascadeClassifier('cascades/data/lbpcascade_frontalface.xml')
...
faces, labels = prepare_training_data("/Users/surajrawat/Desktop/PythExperience/")
print("Data prepared")
